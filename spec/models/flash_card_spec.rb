...
describe FlashCard do 
  ...
  [:front, :back, :difficulty, :deck_id].each do |attr|
  ...
  describe "sequence" do
    it "is autogenerated when nil on save" do
      3.times { FactoryGirl.create(:flash_card) }
      max_sequence = FlashCard.maximum("sequence")
      flash_card = FactoryGirl.build(:flash_card)
      flash_card.sequence = nil
      flash_card.save
      expect(flash_card.sequence).to eq (max_sequence + 1)
    end
  end
